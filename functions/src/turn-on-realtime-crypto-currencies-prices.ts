...
exports[TURN_ON_REALTIME_CRYPTO_CURRENCY_PRICES_FB_FN] = functions.https
	.onCall(async ({ cryptoCurrencyCode }: { cryptoCurrencyCode: CryptoCurrencyCode }) => {
		if (!CRYPTO_CURRENCY_CODES_AND_NAMES[cryptoCurrencyCode]
